...
INSERT INTO items (productID, cost, category, name, description) VALUES (485, 3.99, 150, 'Battery', 'Battery Cleaner - Acid Detector', 'BG Battery Cleaner – Acid Detector removes corrosion from battery terminals, cables and carriers. It also turns red to warn of the presence of acid or a crack or leak around terminal.');
INSERT INTO items (productID, cost,  category, name, description) VALUES (985, 3.99, 150, 'Battery', 'Battery Terminal Protectors', 'BG Battery Terminal Protectors protect battery terminals from corrosive buildup. The chemical formula is harmless to the battery, paint and other parts.  Fits easily onto the battery posts.');
...
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (115, 3.99, 150, 'Engine', 'Extended Life MOA', 'BG Extended Life MOA is formulated with 100 percent synthetic chemistry to protect engine components and fortify all brands of engine oil over extended oil change intervals.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (109, 3.99, 150, 'Engine', 'EPR Engine Performance Restoration', 'BG EPR Engine Performance Restoration is a powerhouse of an engine cleaner! It effectively softens, emulsifies and dissolves even the most stubborn fuel gums that clog rings.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (729, 3.99, 150, 'Engine', 'SAE 0W-20 Full Synthetic Engine Oil', 'BG SAE 0W-20 Full Synthetic Engine Oil is a high quality oil designed for gasoline passenger cars, vans, and light trucks requiring API SN and preceding engine oil.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (737, 3.99, 150, 'Engine', 'SAE 5W-30 Full Synthetic Engine Oil', 'BG SAE 5W-30 Full Synthetic Engine Oil is formulated to give superb performance for gasoline and diesel engines.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (730, 3.99, 150, 'Engine', 'Hi-L0W30 Full Synthetic Engine Oil', 'BG Hi-L0W30 is a revolutionary full synthetic engine oil; it flows immediately to lubricate vital engine components.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (775, 3.99, 150, 'Engine', 'SAE 10W-30 Synthetic Blend Engine Oil', 'BG SAE 10W-30 Synthetic Blend Engine Oil offers outstanding wear protection and oil evaporation prevention. As a professional-use product, it lubricates and cools internal engine surfaces, flows at temperatures as low as -40°F (-40°C), and resists thickening.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (112, 3.99, 150, 'Engine', 'DOC Diesel Oil Conditioner', 'BG DOC Diesel Oil Conditioner is designed to condition oil in high-output diesel engines.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (777, 3.99, 150, 'Engine', 'High-Performance 4-Stroke Engine Oil', 'BG High-Performance 4-Stroke Engine Oil is a revolutionary synthetic blend engine oil formulated to provide maximum small engine protection.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (773, 3.99, 150, 'Engine', 'Synthetic 2-Stroke Engine Oil for Air-Cooled Engines', 'BG Synthetic 2-Stroke Engine Oil for Air-Cooled Engines is a blend of performance oils and proprietary additives specifically for small, air-cooled engines.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (772, 3.99, 150, 'Engine', 'Synthetic 2-Stroke Engine Oil for Water-Cooled Engines', 'BG Synthetic 2-Stroke Engine Oil for Water-Cooled Engines is a blend of performance oils and proprietary additives specifically for small, water-cooled engines.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (714, 3.99, 150, 'Engine', 'SAE 15W-40 Synthetic Blend Engine Oil', 'BG SAE 15W-40 Synthetic Blend Engine Oil offers outstanding wear and evaporation protection for engines.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (713, 3.99, 150, 'Engine', 'SAE 10W-30 HD Synthetic Blend Engine Oil', 'BG SAE 10W-30 HD Synthetic Blend Engine Oil offers outstanding wear and evaporation protection for engines.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (107, 3.99, 150, 'Engine', 'BG RF-7 Oil Treatment', 'BG RF-7 is an oil treatment specially formulated to increase engine compression and power by increasing oil viscosity. It contains additives that keep oil from thickening, protect vital engine parts from corrosive damage, and help seal rings to increase compression and reduce blow-by.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (716, 3.99, 150, 'Engine', 'Shear Power HD', 'BG Shear Power HD is an extended life, premium oil for diesel engines requiring API CK-4 or gasoline engines requiring API SN and preceding engine oil.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (105, 3.99, 150, 'Engine', 'Quick Clean for Engines', 'BG Quick Clean for Engines safely and effectively removes  deposits from engine components.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (116, 3.99, 150, 'Engine', 'Engine Performance Concentrate', 'BG Engine Performance Concentrate provides critical protection for small engines.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (120, 3.99, 150, 'Engine', 'Engine Purge', 'BG Engine Purge is a fix-it product designed to safely remove accumulated sludge and other deposits from the engine.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (208, 3.99, 150, 'Gasoline', '44K Fuel System Cleaner', 'BG 44K is the number one fuel injector cleaner! In a recent survey, dealership service managers chose BG 44K® 6 to 1 over the next aftermarket supplier.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (201, 3.99, 150, 'Gasoline', 'Fuel Injection & Combustion Chamber Cleaner', 'BG Fuel Injection & Combustion Chamber Cleaner is an especially effective gasoline direct injection system cleanup product.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (210, 3.99, 150, 'Gasoline', 'Fuel Injection System Cleaner', 'BG Fuel Injection System Cleaner removes rock-hard carbon deposits from fuel injectors, intake valves and ports.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (260, 3.99, 150, 'Gasoline', 'GDI Intake Valve Cleaner', 'BG GDI Intake Valve Cleaner is a BG lab-tested and proof-positive intake cleaner for all engines (both port fuel injection and gasoline direct injection).');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (206, 3.99, 150, 'Gasoline', 'Air Intake System Cleaner', 'BG Air Intake System Cleaner removes deposits that can accumulate in the air throttle body assemblies and plenums.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (9290-200, 3.99, 150, 'Gasoline', 'VIA Vehicle Injection Apparatus', 'As part of the BG Fuel/Air Induction Service, the BG VIA Vehicle Injection Apparatus provides a highly effective cleaning of the entire fuel system. The BG VIA is a supply tool pressurized by shop air. ');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (9209, 3.99, 150, 'Gasoline', 'Air Intake System Cleaning Tool', 'The BG Air Intake System Cleaning Tool, PN 9209, is specially designed for use with BG GDI Intake Valve Cleaner‚ PN 260‚ to remove sticky, heavy deposits inside the air throttle body and plenum area.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (213, 3.99, 150, 'Gasoline', 'Ethanol Fuel System Defender', 'BG Ethanol System Defender protects the fuel system from the harmful effects of ethanol. It keeps intake manifolds, intake ports, intake valves, and combustion chambers free of deposits caused by ethanol.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (212, 3.99, 150, 'Gasoline', 'Ethanol Corrosion Preventer', 'BG Ethanol Corrosion Preventer forms a protective coating on fuel system components to defend against corrosion. It contains special stabilizers that keep the entire fuel system clean, restoring power and fuel efficiency.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (281, 3.99, 150, 'Gasoline', 'Ethanol Fuel System Drier', 'BG Ethanol Fuel System Drier defends engines against the water that accumulates in ethanol-blended fuel.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (202, 3.99, 150, 'Gasoline', 'Supercharge II', 'BG Supercharge II keeps the fuel system clean and free of fuel deposits. With special stabilizers that prevent fuel oxidation, and gum and varnish formation, it prevents rust and corrosion and provides long-term fuel storage stability.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (203, 3.99, 150, 'Gasoline', 'CF5', 'BG CF5 fuel system cleaner prevents deposits throughout the entire fuel system. Added at each oil change, it will keep injectors, pistons, fuel intake components and sensors clean and free of damaging deposits and corrosion.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (4073, 3.99, 150, 'Gasoline', 'Mass Air Flow Sensor Cleaner', 'BG Mass Air Flow Sensor Cleaner restores Mass Air Flow Sensor and Idle Air Controller function. It quickly cleans all materials contained in these components including hot wires, plastic, and rubber.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (211, 3.99, 150, 'Gasoline', 'ISC Induction System Cleaner', 'BG ISC Induction System Cleaner quickly and safely cleans fuel injectors and removes hard, baked-on carbon deposits from intake valves, combustion chambers and EGR ports.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (9240, 3.99, 150, 'Gasoline', 'EGR Service Tool', 'Used with BG ISC Induction System Cleaner, PN 211, the BG EGR Service Tool allows for total decarbonization of the fuel system.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (280, 3.99, 150, 'Gasoline', 'Fuel System Drier', 'BG Fuel System Drier absorbs moisture that accumulates from condensation in the fuel tank, holding it suspension until it gets burned with fuel. Because of this, it provides easier cold weather starting and prevents fuel icing and freezing.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (271, 3.99, 150, 'Gasoline', 'Gasoline Direct Injection Cleaner Part 1', 'BG Gasoline Direct Injection Cleaner is a two-part cleaning process formulated to soften and disperse baked-on deposits that accumulate on intake valves of direct injected engines.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (272, 3.99, 150, 'Gasoline', 'Gasoline Direct Injection Cleaner Part 2', 'BG Gasoline Direct Injection Cleaner is a two-part cleaning process formulated to soften and disperse baked-on deposits that accumulate on intake valves of direct injected engines.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (408, 3.99, 150, 'Gasoline', 'Inject-A-Flush Injector Cleaner', 'BG Inject-A-Flush Injector Cleaner will safely and effectively clean the fuel injection system without the need to remove the injectors. Built up gums and oxidized fuel residues are dissolved in minutes and removed from the system.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (406, 3.99, 150, 'Gasoline', 'Throttle Body & Intake Cleaner', 'BG Throttle Body & Intake Cleaner quickly and safely removes accumulated deposits from the butterfly/throttle valve, throttle body and idle air control valves of the air induction system.');
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (411, 3.99, 150, 'Gasoline', 'Carb and Choke Cleaner', 'BG Carb and Choke Cleaner contains a special blend of solvents that powers through harmful carbon, gum, and varnish deposits, cleans carburetors, automatic chokes, PCV valves and lines, and manifold heat control valves.');
