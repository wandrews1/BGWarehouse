...
INSERT INTO items (productID, cost, category, name, description) VALUES (9700, 3.99, 'Diesel', 'Diesel VIA', 'BG Diesel VIA is the ultimate diesel injector cleaning system for passenger cars, SUVs and light trucks.');
...
INSERT INTO items (productID, cost, category, name, description) VALUES (9255, 3.99, 'Diesel', 'Diesel Induction Service Set', 'As part of the Diesel Induction Service, the BG Diesel Induction Service Set sends BG Diesel ISC Induction System Cleaner through the EGR runners and the fresh air intake.');
...
INSERT INTO items (productID, cost, category, name, description) VALUES (9290, 3.99, 'Gasoline', 'VIA Vehicle Injection Apparatus', 'As part of the BG Fuel/Air Induction Service, the BG VIA Vehicle Injection Apparatus provides a highly effective cleaning of the entire fuel system. The BG VIA is a supply tool pressurized by shop air. ');
...
CREATE TABLE warehouses (
  ...
  bg485 int NOT NULL DEFAULT 150,
  bg985 int NOT NULL DEFAULT 150,
  bg490 int NOT NULL DEFAULT 150,
  bg885 int NOT NULL DEFAULT 150,
  bg979 int NOT NULL DEFAULT 150,
  bg841 int NOT NULL DEFAULT 150,
  bg840 int NOT NULL DEFAULT 150,
  bg835 int NOT NULL DEFAULT 150,
  bg850 int NOT NULL DEFAULT 150,
  bg402 int NOT NULL DEFAULT 150,
  bg403 int NOT NULL DEFAULT 150,
  bg860 int NOT NULL DEFAULT 150,
  bg709 int NOT NULL DEFAULT 150,
  bg701 int NOT NULL DEFAULT 150,
  bg702 int NOT NULL DEFAULT 150,
  bg704 int NOT NULL DEFAULT 150,
  bg708 int NOT NULL DEFAULT 150,
  bg917 int NOT NULL DEFAULT 150,
  bg546 int NOT NULL DEFAULT 150,
  bg540 int NOT NULL DEFAULT 150,
  bg511 int NOT NULL DEFAULT 150,
  bg589 int NOT NULL DEFAULT 150,
  bg587 int NOT NULL DEFAULT 150,
  bg245 int NOT NULL DEFAULT 150,
  bg244 int NOT NULL DEFAULT 150,
  bg229 int NOT NULL DEFAULT 150,
  bg9700 int NOT NULL DEFAULT 150,
  bg227 int NOT NULL DEFAULT 150,
  bg230 int NOT NULL DEFAULT 150,
  bg247 int NOT NULL DEFAULT 150,
  bg248 int NOT NULL DEFAULT 150,
  bg225 int NOT NULL DEFAULT 150,
  bg232 int NOT NULL DEFAULT 150,
  bg237 int NOT NULL DEFAULT 150,
  bg240 int NOT NULL DEFAULT 150,
  bg256 int NOT NULL DEFAULT 150,
  bg255 int NOT NULL DEFAULT 150,
  bg9255 int NOT NULL DEFAULT 150,
  bg2581 int NOT NULL DEFAULT 150,
  bg9300 int NOT NULL DEFAULT 150,
  bg233 int NOT NULL DEFAULT 150,
  bg215 int NOT NULL DEFAULT 150,
  bg228 int NOT NULL DEFAULT 150,
  bg224 int NOT NULL DEFAULT 150,
  bg751 int NOT NULL DEFAULT 150,
  bg753 int NOT NULL DEFAULT 150,
  bg792 int NOT NULL DEFAULT 150,
  bg939 int NOT NULL DEFAULT 150,
  bg752 int NOT NULL DEFAULT 150,
  bg750 int NOT NULL DEFAULT 150,
  bg328 int NOT NULL DEFAULT 150,
  bg325 int NOT NULL DEFAULT 150,
  bg110 int NOT NULL DEFAULT 150,
  bg115 int NOT NULL DEFAULT 150,
  bg109 int NOT NULL DEFAULT 150,
  bg729 int NOT NULL DEFAULT 150,
  bg737 int NOT NULL DEFAULT 150,
  bg730 int NOT NULL DEFAULT 150,
  bg775 int NOT NULL DEFAULT 150,
  bg112 int NOT NULL DEFAULT 150,
  bg777 int NOT NULL DEFAULT 150,
  bg773 int NOT NULL DEFAULT 150,
  bg772 int NOT NULL DEFAULT 150,
  bg714 int NOT NULL DEFAULT 150,
  bg713 int NOT NULL DEFAULT 150,
  bg107 int NOT NULL DEFAULT 150,
  bg716 int NOT NULL DEFAULT 150,
  bg105 int NOT NULL DEFAULT 150,
  bg116 int NOT NULL DEFAULT 150,
  bg120 int NOT NULL DEFAULT 150,
  bg208 int NOT NULL DEFAULT 150,
  bg201 int NOT NULL DEFAULT 150,
  bg210 int NOT NULL DEFAULT 150,
  bg260 int NOT NULL DEFAULT 150,
  bg206 int NOT NULL DEFAULT 150,
  bg9290 int NOT NULL DEFAULT 150,
  bg9209 int NOT NULL DEFAULT 150,
  bg213 int NOT NULL DEFAULT 150,
  bg212 int NOT NULL DEFAULT 150,
  bg281 int NOT NULL DEFAULT 150,
  bg202 int NOT NULL DEFAULT 150,
  bg203 int NOT NULL DEFAULT 150,
  bg4073 int NOT NULL DEFAULT 150,
  bg211 int NOT NULL DEFAULT 150,
  bg9240 int NOT NULL DEFAULT 150,
  bg280 int NOT NULL DEFAULT 150,
  bg271 int NOT NULL DEFAULT 150,
  bg272 int NOT NULL DEFAULT 150,
  bg408 int NOT NULL DEFAULT 150,
  bg406 int NOT NULL DEFAULT 150,
  bg411 int NOT NULL DEFAULT 150,
  bg412 int NOT NULL DEFAULT 150,
  bg209 int NOT NULL DEFAULT 150,
...
DECLARE 
  quantity int;
BEGIN
  EXECUTE format('SELECT CAST(%I AS VARCHAR) FROM warehouses WHERE warehouseID = %s', productID, warehouseID)
    INTO quantity
    USING warehouseID;
  RETURN quantity;
END;
