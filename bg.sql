...
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (485, 3.99, 150, 'Battery', 'Battery Cleaner - Acid Detector', 'Battery terminals, cables and carriers are vulnerable to corrosive buildup, which can drain the power from a battery. BG Battery Cleaner – Acid Detector removes corrosion from battery terminals, cables and carriers. It also turns red to warn of the presence of acid or a crack or leak around terminal.');
...
INSERT INTO items (productID, cost, quantity, category, name, description) VALUES (792, 3.99, 150, 'DriveLine', 'Syncro Shift II', 'BG Syncro Shift® II is a specially formulated gear lubricant designed for front wheel drive manual transmissions. It reduces maintenance costs by improving thermal stability, low-temperature fluidity, and shear stability while providing smoother shifting and improved seal compatibility.');
