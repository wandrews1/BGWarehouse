...
@app.route('/warehousetransfer', methods=['GET', 'POST'])
def showWarehouseTransfer():
	results = 0
	warehouse = 1
	itementered = 1
	item = 1
	...
	warehouse1 = pg.checkWarehouse(wh1)
	warehouse2 = pg.checkWarehouse(wh2)
